...
const AgentDetailsView: React.FC<AgentDetailsViewProps> = ({ agent, onBack }) => {
  ...
  useEffect(() => {
    const fetchAnomalies = async () => {
      ...
      setLoading(true)
      try {
        const url = `https://https://ai-call-summary-api-hpb0afdgbtb6e5ca.centralus-01.azurewebsites.net/anomaly-agent-details?agentname=${encodeURIComponent(agentName)}`
