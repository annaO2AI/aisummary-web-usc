...
export default function AgentSummaryPage() {
  ...
  const fetchAgents = useCallback(async () => {
    ...
    try {
      ...
      const url = `https://https://ai-call-summary-api-hpb0afdgbtb6e5ca.centralus-01.azurewebsites.net/agent_statistics?start_datetime=${startParam}&end_datetime=${endParam}`
